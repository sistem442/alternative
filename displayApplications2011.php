...
<title>Prikazivanje prijava</title>
...
//izbor baze
mysql_select_db("dksg_alternative", $con);
...
$query = ("SELECT * FROM prijave2011 LIMIT $from, $max_results");
//echo $query;
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM prijave2011"),0);  
