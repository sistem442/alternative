...
<form action="aplicationFormResult.php"  method="post" enctype="multipart/form-data" name="applicationForm">
  Application Form <br>
  <br/>
  <br/>  
  <br/>
  <table border="0" cellspacing="10px" >
    <tbody>
      ...
      <tr>
        <td> Other </td>
        <td><textarea cols="30" rows="7"   id="other" name="other"></textarea></td>
      </tr>
      <tr>
        <td> Production </td>
      ...
      <tr>
        <td> Production Telephone (not required)</td>
        <td><input type="text" id="ptel" name="ptel"/></td>
      </tr>
      <tr>
        <td> Production Fax (not required)</td>
        <td><input type="text" id="pfax" name="pfax"/></td>
      </tr>
      <tr>
        <td> Production E-mail </td>
      ...
      <tr>
        <td> Synopsis</td>
        <td><textarea cols="30" rows="10"   id="sinopsis" name="sinopsis" onblur="ckeckIfEmty(this.value)"></textarea></td>
      </tr>
      <tr>
        <td> Short bio/filmography</td>
        <td><textarea cols="30" rows="10"   id="bio-filmography" name="bio-filmography" onblur="ckeckIfEmty(this.value)"> </textarea></td>
      </tr>
<tr>
<td>
  </td>
...
<tr>
<td> Photo of  director(max size 1MB):  
</td>
<td bgcolor="#999999">
...
<tr>
<td>Still from film 1 (max size 1MB):</td>
<td bgcolor="#999999">
<input type="hidden" name="MAX_FILE_SIZE" value="1048576">
<input name="ufile[]" type="file" id="ufile[]" size="50" /></td>
</tr>
...
<tr>
<td colspan="2">
  <p>Address for sending us preview DVD is (unless you decide to send us preview link): <br />
    <strong>Festival Alternative  Film / Video<br />
      Students' City Cultural Center  <br />
      Bulevar Zorana Đinđića 179<br />
      11070 Novi Beograd<br />
      Serbia</strong></p>
  <p>Application Deadline: October 20th, 2014</p>
</td>
</tr>
    </tbody>
  </table>
